...
required_paths='AGENTS.md README.md chezmoi/.chezmoiignore chezmoi/dot_config/niri/cfg/input.kdl chezmoi/dot_config/niri/cfg/keybinds.kdl chezmoi/dot_config/niri/cfg/layout.kdl chezmoi/dot_config/noctalia/templates.toml packages/pacman.txt packages/aur.txt docs/adr/README.md docs/adr/ADR-0001-use-chezmoi-for-dotfile-management.md docs/adr/ADR-0002-use-noctalia-for-dynamic-niri-colors.md scripts/bootstrap.sh tests/validate.fish'
